...
const htmlPath = path.join(root, "实验2-个人软件选题与需求分析.html");
const title = "软工2班-24111302097-蔡春阳-实验2-个人软件选题与需求分析";
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    h1 { color: #153e75; font-size: 22pt; line-height: 1.25; margin: 0 0 16pt; page-break-before: avoid; }
    ...
    pre { background: #111827; color: #f9fafb; padding: 9pt 11pt; border-radius: 4pt; overflow-wrap: anywhere; white-space: pre-wrap; font-size: 8.2pt; line-height: 1.45; }
    pre code { background: transparent; color: inherit; padding: 0; }
    table { width: 100%; border-collapse: collapse; margin: 7pt 0 11pt; font-size: 8pt; page-break-inside: auto; }
    ...
    li { margin: 2pt 0; }
    img { display: block; max-width: 100%; max-height: 190mm; height: auto; margin: 8pt auto 12pt; border: 0.6pt solid #9caec0; }
